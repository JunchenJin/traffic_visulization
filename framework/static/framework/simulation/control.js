...
'  </div>' +
'</footer>'+
'<div id="load-tracks-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="load-tracks-label" aria-hidden="true">' +
...
'</div>',
  ...
  onAdd: function(map) {
  	// Really be careful about the location of the  
  	// controller, which should be after the map?
  	// When I add it to footer directly, the popup of 
  	// speed slider is blocked by the map.
  	// Perhaps we need to solve the problem of zooming in
  	// but ojects are lagged.
